          ...
          <div class="prose max-w-none text-gray-600 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              <div class="bg-indigo-50 p-6 rounded-xl">
                <h3 class="text-xl font-bold text-indigo-900 mb-2">Soporte General</h3>
                <p class="text-indigo-700">Para consultas sobre tu cuenta o el uso de la plataforma.</p>
              ...
              <div class="bg-purple-50 p-6 rounded-xl">
                <h3 class="text-xl font-bold text-purple-900 mb-2">Empresas</h3>
                <p class="text-purple-700">Para información sobre cómo publicar vacantes y planes corporativos.</p>
            ...
            <div class="mt-8 border-t border-gray-100 pt-6">
              <h3 class="text-lg font-semibold text-gray-800 mb-2">Oficinas</h3>
